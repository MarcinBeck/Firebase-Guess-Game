...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // PRZEPISANA FUNKCJA, KTÓRA POPRAWNIE OBSŁUGUJE LUKI W DANYCH
    function updateAccuracyChart(samples, predictions) {
        ...
        // Krok 1: Grupujemy predykcje w "koszykach" co 5 próbek
        ...
        // Krok 2: Tworzymy etykiety i dane dla wykresu, wstawiając 'NaN' dla pustych przedziałów
        ...
        for (let i = 0; i <= maxInterval; i++) {
            ...
            if (predictionsByInterval[i] && predictionsByInterval[i].length > 0) {
                ...
                // NaN (Not a Number) jest interpretowane przez Chart.js jako przerwa w linii
                chartData.push(NaN); 
            }
        }
        ...
        accuracyChart = new Chart(accuracyChartCtx, {
            ...
            data: {
                ...
                datasets: [
                {
                    ...
                    borderColor: '#38bdf8',
                    tension: 0.1,
                    spanGaps: false, // Ważne: nie łączymy linii nad przerwami
                },
                {
